 ...
 */
class Shortify_WP_Google_Config
{
  ...
  /**
   * Create a new Shortify_WP_Google_Config. Can accept an ini file location with the
  ...
  public function __construct($ini_file_location = null)
  {
    $this->configuration = array(
      ...
      'auth_class'    => 'Shortify_WP_Google_Auth_OAuth2',
      'io_class'      => self::USE_AUTO_IO_SELECTION,
      'cache_class'   => 'Shortify_WP_Google_Cache_File',
      ...
      'classes' => array(
        'Shortify_WP_Google_IO_Abstract' => array(
          'request_timeout_seconds' => 100,
        ),
        'Shortify_WP_Google_Http_Request' => array(
        ...
        'Shortify_WP_Google_Auth_OAuth2' => array(
        ...
        'Shortify_WP_Google_Cache_File' => array(
          'directory' => sys_get_temp_dir() . '/Shortify_WP_Google_Client'
        )
      ),
