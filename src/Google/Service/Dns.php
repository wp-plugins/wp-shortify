 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_Dns extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->changes = new Shortify_WP_Google_Service_Dns_Changes_Resource(
        $this,
        $this->serviceName,
        'changes',
        array(
    ...
    $this->managedZones = new Shortify_WP_Google_Service_Dns_ManagedZones_Resource(
        $this,
        $this->serviceName,
        'managedZones',
        array(
    ...
    $this->projects = new Shortify_WP_Google_Service_Dns_Projects_Resource(
        $this,
        $this->serviceName,
        'projects',
        array(
    ...
    $this->resourceRecordSets = new Shortify_WP_Google_Service_Dns_ResourceRecordSets_Resource(
        $this,
        $this->serviceName,
        'resourceRecordSets',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $dnsService = new Shortify_WP_Google_Service_Dns(...);
 *   $changes = $dnsService->changes;
 *  </code>
 */
class Shortify_WP_Google_Service_Dns_Changes_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @param Shortify_WP_Google_Change $postBody
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_Dns_Change
   */
  public function create($project, $managedZone, Shortify_WP_Google_Service_Dns_Change $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Shortify_WP_Google_Service_Dns_Change");
  }
  /**
  ...
  public function get($project, $managedZone, $changeId, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Shortify_WP_Google_Service_Dns_Change");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Dns_ChangesListResponse
   */
  public function listChanges($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Shortify_WP_Google_Service_Dns_ChangesListResponse");
  }
}
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_Dns_ManagedZones_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @param string $project
   * Identifies the project addressed by this request.
   * @param Shortify_WP_Google_ManagedZone $postBody
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_Dns_ManagedZone
   */
  public function create($project, Shortify_WP_Google_Service_Dns_ManagedZone $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Shortify_WP_Google_Service_Dns_ManagedZone");
  }
  /**
  ...
  public function get($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Shortify_WP_Google_Service_Dns_ManagedZone");
  }
  /**
   ...
   * Optional. Maximum number of results to be returned. If unspecified, the server will decide how
    * many results to return.
   * @return Shortify_WP_Google_Service_Dns_ManagedZonesListResponse
   */
  public function listManagedZones($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Shortify_WP_Google_Service_Dns_ManagedZonesListResponse");
  }
}
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_Dns_Projects_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * Identifies the project addressed by this request.
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_Dns_Project
   */
  public function get($project, $optParams = array())
  {
    $params = array('project' => $project);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Shortify_WP_Google_Service_Dns_Project");
  }
}
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_Dns_ResourceRecordSets_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * Restricts the list to return only records of this type. If present, the "name" parameter must
    * also be present.
   * @return Shortify_WP_Google_Service_Dns_ResourceRecordSetsListResponse
   */
  public function listResourceRecordSets($project, $managedZone, $optParams = array())
  {
    $params = array('project' => $project, 'managedZone' => $managedZone);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Shortify_WP_Google_Service_Dns_ResourceRecordSetsListResponse");
  }
}
...
class Shortify_WP_Google_Service_Dns_Change extends Shortify_WP_Google_Collection
{
  protected $additionsType = 'Shortify_WP_Google_Service_Dns_ResourceRecordSet';
  protected $additionsDataType = 'array';
  protected $deletionsType = 'Shortify_WP_Google_Service_Dns_ResourceRecordSet';
...
class Shortify_WP_Google_Service_Dns_ChangesListResponse extends Shortify_WP_Google_Collection
{
  protected $changesType = 'Shortify_WP_Google_Service_Dns_Change';
...
class Shortify_WP_Google_Service_Dns_ManagedZone extends Shortify_WP_Google_Collection
{
  public $creationTime;
  public $description;
  public $dnsName;
...
class Shortify_WP_Google_Service_Dns_ManagedZonesListResponse extends Shortify_WP_Google_Collection
{
  public $kind;
  protected $managedZonesType = 'Shortify_WP_Google_Service_Dns_ManagedZone';
...
class Shortify_WP_Google_Service_Dns_Project extends Shortify_WP_Google_Model
{
  public $id;
  public $kind;
  public $number;
  protected $quotaType = 'Shortify_WP_Google_Service_Dns_Quota';
  ...
  public function setQuota(Shortify_WP_Google_Service_Dns_Quota $quota)
  {
    $this->quota = $quota;
  }
...
class Shortify_WP_Google_Service_Dns_Quota extends Shortify_WP_Google_Model
{
  public $kind;
  public $managedZones;
...
class Shortify_WP_Google_Service_Dns_ResourceRecordSet extends Shortify_WP_Google_Collection
{
  public $kind;
  public $name;
  public $rrdatas;
...
class Shortify_WP_Google_Service_Dns_ResourceRecordSetsListResponse extends Shortify_WP_Google_Collection
{
  public $kind;
  public $nextPageToken;
  protected $rrsetsType = 'Shortify_WP_Google_Service_Dns_ResourceRecordSet';
