 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_YouTubeAnalytics extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->batchReportDefinitions = new Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource(
        $this,
        $this->serviceName,
    ...
    $this->batchReports = new Shortify_WP_Google_Service_YouTubeAnalytics_BatchReports_Resource(
        $this,
        $this->serviceName,
        'batchReports',
        array(
    ...
    $this->reports = new Shortify_WP_Google_Service_YouTubeAnalytics_Reports_Resource(
        $this,
        $this->serviceName,
        'reports',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $youtubeAnalyticsService = new Shortify_WP_Google_Service_YouTubeAnalytics(...);
 *   $batchReportDefinitions = $youtubeAnalyticsService->batchReportDefinitions;
 *  </code>
 */
class Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportDefinitions_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @return Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportDefinitionList
   */
  public function listBatchReportDefinitions($onBehalfOfContentOwner, $optParams = array())
  {
    ...
    return $this->call('list', array($params), "Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportDefinitionList");
  }
}
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_YouTubeAnalytics_BatchReports_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * The onBehalfOfContentOwner parameter identifies the content owner that the user is acting on
    * behalf of.
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportList
   */
  public function listBatchReports($batchReportDefinitionId, $onBehalfOfContentOwner, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportList");
  }
}
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_YouTubeAnalytics_Reports_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @return Shortify_WP_Google_Service_YouTubeAnalytics_ResultTable
   */
  public function query($ids, $startDate, $endDate, $metrics, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('query', array($params), "Shortify_WP_Google_Service_YouTubeAnalytics_ResultTable");
  }
}
...
class Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportDefinitionList extends Shortify_WP_Google_Collection
{
  protected $itemsType = 'Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplate';
...
class Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplate extends Shortify_WP_Google_Collection
{
  protected $defaultOutputType = 'Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplateDefaultOutput';
...
class Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportDefinitionTemplateDefaultOutput extends Shortify_WP_Google_Model
{
  public $format;
  public $type;
...
class Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportList extends Shortify_WP_Google_Collection
{
  protected $itemsType = 'Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportTemplate';
  protected $itemsDataType = 'array';
  public $kind;
...
class Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportTemplate extends Shortify_WP_Google_Collection
{
  public $id;
  protected $outputsType = 'Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportTemplateOutputs';
  protected $outputsDataType = 'array';
  public $reportId;
  protected $timeSpanType = 'Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan';
  ...
  public function setTimeSpan(Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan $timeSpan)
  {
...
class Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportTemplateOutputs extends Shortify_WP_Google_Model
{
  public $downloadUrl;
  public $format;
  public $type;
...
class Shortify_WP_Google_Service_YouTubeAnalytics_BatchReportTemplateTimeSpan extends Shortify_WP_Google_Model
{
  public $endTime;
  public $startTime;
...
class Shortify_WP_Google_Service_YouTubeAnalytics_ResultTable extends Shortify_WP_Google_Collection
{
  protected $columnHeadersType = 'Shortify_WP_Google_Service_YouTubeAnalytics_ResultTableColumnHeaders';
...
class Shortify_WP_Google_Service_YouTubeAnalytics_ResultTableColumnHeaders extends Shortify_WP_Google_Model
{
  public $columnType;
  public $dataType;
  public $name;
