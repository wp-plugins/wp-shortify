 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_GamesManagement extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->achievements = new Shortify_WP_Google_Service_GamesManagement_Achievements_Resource(
        $this,
        $this->serviceName,
        'achievements',
        array(
    ...
    $this->applications = new Shortify_WP_Google_Service_GamesManagement_Applications_Resource(
        $this,
        $this->serviceName,
        'applications',
        array(
    ...
    $this->events = new Shortify_WP_Google_Service_GamesManagement_Events_Resource(
        $this,
        $this->serviceName,
        'events',
        array(
    ...
    $this->players = new Shortify_WP_Google_Service_GamesManagement_Players_Resource(
        $this,
        $this->serviceName,
        'players',
        array(
    ...
    $this->quests = new Shortify_WP_Google_Service_GamesManagement_Quests_Resource(
        $this,
        $this->serviceName,
        'quests',
        array(
    ...
    $this->rooms = new Shortify_WP_Google_Service_GamesManagement_Rooms_Resource(
        $this,
        $this->serviceName,
        'rooms',
        array(
    ...
    $this->scores = new Shortify_WP_Google_Service_GamesManagement_Scores_Resource(
        $this,
        $this->serviceName,
        'scores',
        array(
    ...
    $this->turnBasedMatches = new Shortify_WP_Google_Service_GamesManagement_TurnBasedMatches_Resource(
        $this,
        $this->serviceName,
        'turnBasedMatches',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $gamesManagementService = new Shortify_WP_Google_Service_GamesManagement(...);
 *   $achievements = $gamesManagementService->achievements;
 *  </code>
 */
class Shortify_WP_Google_Service_GamesManagement_Achievements_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @return Shortify_WP_Google_Service_GamesManagement_AchievementResetResponse
   */
  public function reset($achievementId, $optParams = array())
  {
    $params = array('achievementId' => $achievementId);
    $params = array_merge($params, $optParams);
    return $this->call('reset', array($params), "Shortify_WP_Google_Service_GamesManagement_AchievementResetResponse");
  }
  /**
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_GamesManagement_AchievementResetAllResponse
   */
  public function resetAll($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('resetAll', array($params), "Shortify_WP_Google_Service_GamesManagement_AchievementResetAllResponse");
  }
  /**
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_GamesManagement_Applications_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * The maximum number of player resources to return in the response, used for paging. For any
    ...
    * maxResults.
   * @return Shortify_WP_Google_Service_GamesManagement_HiddenPlayerList
   */
  public function listHidden($applicationId, $optParams = array())
  {
    $params = array('applicationId' => $applicationId);
    $params = array_merge($params, $optParams);
    return $this->call('listHidden', array($params), "Shortify_WP_Google_Service_GamesManagement_HiddenPlayerList");
  }
}
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_GamesManagement_Events_Resource extends Shortify_WP_Google_Service_Resource
{
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_GamesManagement_Players_Resource extends Shortify_WP_Google_Service_Resource
{
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_GamesManagement_Quests_Resource extends Shortify_WP_Google_Service_Resource
{
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_GamesManagement_Rooms_Resource extends Shortify_WP_Google_Service_Resource
{
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_GamesManagement_Scores_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_GamesManagement_PlayerScoreResetResponse
   */
  public function reset($leaderboardId, $optParams = array())
  {
    $params = array('leaderboardId' => $leaderboardId);
    $params = array_merge($params, $optParams);
    return $this->call('reset', array($params), "Shortify_WP_Google_Service_GamesManagement_PlayerScoreResetResponse");
  }
  /**
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_GamesManagement_TurnBasedMatches_Resource extends Shortify_WP_Google_Service_Resource
{
...
class Shortify_WP_Google_Service_GamesManagement_AchievementResetAllResponse extends Shortify_WP_Google_Collection
{
  public $kind;
  protected $resultsType = 'Shortify_WP_Google_Service_GamesManagement_AchievementResetResponse';
...
class Shortify_WP_Google_Service_GamesManagement_AchievementResetResponse extends Shortify_WP_Google_Model
{
  public $currentState;
  public $definitionId;
  public $kind;
...
class Shortify_WP_Google_Service_GamesManagement_GamesPlayedResource extends Shortify_WP_Google_Model
{
  public $autoMatched;
  public $timeMillis;
...
class Shortify_WP_Google_Service_GamesManagement_GamesPlayerExperienceInfoResource extends Shortify_WP_Google_Model
{
  public $currentExperiencePoints;
  protected $currentLevelType = 'Shortify_WP_Google_Service_GamesManagement_GamesPlayerLevelResource';
  protected $currentLevelDataType = '';
  public $lastLevelUpTimestampMillis;
  protected $nextLevelType = 'Shortify_WP_Google_Service_GamesManagement_GamesPlayerLevelResource';
  ...
  public function setCurrentLevel(Shortify_WP_Google_Service_GamesManagement_GamesPlayerLevelResource $currentLevel)
  {
  ...
  public function setNextLevel(Shortify_WP_Google_Service_GamesManagement_GamesPlayerLevelResource $nextLevel)
  {
...
class Shortify_WP_Google_Service_GamesManagement_GamesPlayerLevelResource extends Shortify_WP_Google_Model
{
  public $level;
...
class Shortify_WP_Google_Service_GamesManagement_HiddenPlayer extends Shortify_WP_Google_Model
{
  public $hiddenTimeMillis;
  public $kind;
  protected $playerType = 'Shortify_WP_Google_Service_GamesManagement_Player';
  ...
  public function setPlayer(Shortify_WP_Google_Service_GamesManagement_Player $player)
  {
    $this->player = $player;
  }
...
class Shortify_WP_Google_Service_GamesManagement_HiddenPlayerList extends Shortify_WP_Google_Collection
{
  protected $itemsType = 'Shortify_WP_Google_Service_GamesManagement_HiddenPlayer';
...
class Shortify_WP_Google_Service_GamesManagement_Player extends Shortify_WP_Google_Model
{
  public $avatarImageUrl;
  public $displayName;
  protected $experienceInfoType = 'Shortify_WP_Google_Service_GamesManagement_GamesPlayerExperienceInfoResource';
  protected $experienceInfoDataType = '';
  public $kind;
  protected $lastPlayedWithType = 'Shortify_WP_Google_Service_GamesManagement_GamesPlayedResource';
  protected $lastPlayedWithDataType = '';
  protected $nameType = 'Shortify_WP_Google_Service_GamesManagement_PlayerName';
  ...
  public function setExperienceInfo(Shortify_WP_Google_Service_GamesManagement_GamesPlayerExperienceInfoResource $experienceInfo)
  {
  ...
  public function setLastPlayedWith(Shortify_WP_Google_Service_GamesManagement_GamesPlayedResource $lastPlayedWith)
  {
  ...
  public function setName(Shortify_WP_Google_Service_GamesManagement_PlayerName $name)
  {
    $this->name = $name;
  }
...
class Shortify_WP_Google_Service_GamesManagement_PlayerName extends Shortify_WP_Google_Model
{
  public $familyName;
  public $givenName;
...
class Shortify_WP_Google_Service_GamesManagement_PlayerScoreResetResponse extends Shortify_WP_Google_Collection
{
  public $kind;
