 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_CivicInfo extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->divisions = new Shortify_WP_Google_Service_CivicInfo_Divisions_Resource(
        $this,
        $this->serviceName,
        'divisions',
        array(
    ...
    $this->elections = new Shortify_WP_Google_Service_CivicInfo_Elections_Resource(
        $this,
        $this->serviceName,
        'elections',
        array(
    ...
    $this->representatives = new Shortify_WP_Google_Service_CivicInfo_Representatives_Resource(
        $this,
        $this->serviceName,
        'representatives',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $civicinfoService = new Shortify_WP_Google_Service_CivicInfo(...);
 *   $divisions = $civicinfoService->divisions;
 *  </code>
 */
class Shortify_WP_Google_Service_CivicInfo_Divisions_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @return Shortify_WP_Google_Service_CivicInfo_DivisionSearchResponse
   */
  public function search($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Shortify_WP_Google_Service_CivicInfo_DivisionSearchResponse");
  }
}
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_CivicInfo_Elections_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   *
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_CivicInfo_ElectionsQueryResponse
   */
  public function electionQuery($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('electionQuery', array($params), "Shortify_WP_Google_Service_CivicInfo_ElectionsQueryResponse");
  }
  /**
   ...
   * @param Shortify_WP_Google_VoterInfoRequest $postBody
   * @param array $optParams Optional parameters.
   *
   * @opt_param bool officialOnly
   * If set to true, only data from official state sources will be returned.
   * @return Shortify_WP_Google_Service_CivicInfo_VoterInfoResponse
   */
  public function voterInfoQuery($electionId, Shortify_WP_Google_Service_CivicInfo_VoterInfoRequest $postBody, $optParams = array())
  {
    $params = array('electionId' => $electionId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('voterInfoQuery', array($params), "Shortify_WP_Google_Service_CivicInfo_VoterInfoResponse");
  }
}
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_CivicInfo_Representatives_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   *
   * @param Shortify_WP_Google_RepresentativeInfoRequest $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Shortify_WP_Google_Service_CivicInfo_RepresentativeInfoResponse
   */
  public function representativeInfoQuery(Shortify_WP_Google_Service_CivicInfo_RepresentativeInfoRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('representativeInfoQuery', array($params), "Shortify_WP_Google_Service_CivicInfo_RepresentativeInfoResponse");
  }
}
...
class Shortify_WP_Google_Service_CivicInfo_AdministrationRegion extends Shortify_WP_Google_Collection
{
  protected $electionAdministrationBodyType = 'Shortify_WP_Google_Service_CivicInfo_AdministrativeBody';
  protected $electionAdministrationBodyDataType = '';
  public $id;
  protected $localJurisdictionType = 'Shortify_WP_Google_Service_CivicInfo_AdministrationRegion';
  protected $localJurisdictionDataType = '';
  public $name;
  protected $sourcesType = 'Shortify_WP_Google_Service_CivicInfo_Source';
  protected $sourcesDataType = 'array';

  public function setElectionAdministrationBody(Shortify_WP_Google_Service_CivicInfo_AdministrativeBody $electionAdministrationBody)
  {
  ...
  public function setLocalJurisdiction(Shortify_WP_Google_Service_CivicInfo_AdministrationRegion $localJurisdiction)
  {
...
class Shortify_WP_Google_Service_CivicInfo_AdministrativeBody extends Shortify_WP_Google_Collection
{
  public $absenteeVotingInfoUrl;
  public $ballotInfoUrl;
  protected $correspondenceAddressType = 'Shortify_WP_Google_Service_CivicInfo_SimpleAddressType';
  protected $correspondenceAddressDataType = '';
  public $electionInfoUrl;
  protected $electionOfficialsType = 'Shortify_WP_Google_Service_CivicInfo_ElectionOfficial';
  ...
  public $name;
  protected $physicalAddressType = 'Shortify_WP_Google_Service_CivicInfo_SimpleAddressType';
  ...
  public function setCorrespondenceAddress(Shortify_WP_Google_Service_CivicInfo_SimpleAddressType $correspondenceAddress)
  {
  ...
  public function setPhysicalAddress(Shortify_WP_Google_Service_CivicInfo_SimpleAddressType $physicalAddress)
  {
...
class Shortify_WP_Google_Service_CivicInfo_Candidate extends Shortify_WP_Google_Collection
{
  public $candidateUrl;
  protected $channelsType = 'Shortify_WP_Google_Service_CivicInfo_Channel';
...
class Shortify_WP_Google_Service_CivicInfo_Channel extends Shortify_WP_Google_Model
{
  public $id;
  public $type;
...
class Shortify_WP_Google_Service_CivicInfo_Contest extends Shortify_WP_Google_Collection
{
  public $ballotPlacement;
  protected $candidatesType = 'Shortify_WP_Google_Service_CivicInfo_Candidate';
  protected $candidatesDataType = 'array';
  protected $districtType = 'Shortify_WP_Google_Service_CivicInfo_ElectoralDistrict';
  ...
  public function setDistrict(Shortify_WP_Google_Service_CivicInfo_ElectoralDistrict $district)
  {
...
class Shortify_WP_Google_Service_CivicInfo_DivisionSearchResponse extends Shortify_WP_Google_Collection
{
  public $kind;
  protected $resultsType = 'Shortify_WP_Google_Service_CivicInfo_DivisionSearchResult';
...
class Shortify_WP_Google_Service_CivicInfo_DivisionSearchResult extends Shortify_WP_Google_Collection
{
  public $aliases;
  public $name;
  public $ocdId;
...
class Shortify_WP_Google_Service_CivicInfo_Election extends Shortify_WP_Google_Model
{
  public $electionDay;
  public $id;
  public $name;
...
class Shortify_WP_Google_Service_CivicInfo_ElectionOfficial extends Shortify_WP_Google_Model
{
  public $emailAddress;
  public $faxNumber;
  public $name;
...
class Shortify_WP_Google_Service_CivicInfo_ElectionsQueryResponse extends Shortify_WP_Google_Collection
{
  protected $electionsType = 'Shortify_WP_Google_Service_CivicInfo_Election';
...
class Shortify_WP_Google_Service_CivicInfo_ElectoralDistrict extends Shortify_WP_Google_Model
{
  public $id;
  public $name;
  public $scope;
...
class Shortify_WP_Google_Service_CivicInfo_GeographicDivision extends Shortify_WP_Google_Collection
{
  public $alsoKnownAs;
  public $name;
  public $officeIds;
...
class Shortify_WP_Google_Service_CivicInfo_Office extends Shortify_WP_Google_Collection
{
  public $divisionId;
  public $level;
  public $name;
...
class Shortify_WP_Google_Service_CivicInfo_Official extends Shortify_WP_Google_Collection
{
  protected $addressType = 'Shortify_WP_Google_Service_CivicInfo_SimpleAddressType';
...
class Shortify_WP_Google_Service_CivicInfo_PollingLocation extends Shortify_WP_Google_Collection
{
  protected $addressType = 'Shortify_WP_Google_Service_CivicInfo_SimpleAddressType';
  ...
  public function setAddress(Shortify_WP_Google_Service_CivicInfo_SimpleAddressType $address)
  {
    $this->address = $address;
  }
...
class Shortify_WP_Google_Service_CivicInfo_RepresentativeInfoRequest extends Shortify_WP_Google_Model
{
  public $address;
...
class Shortify_WP_Google_Service_CivicInfo_RepresentativeInfoResponse extends Shortify_WP_Google_Model
{
  protected $divisionsType = 'Shortify_WP_Google_Service_CivicInfo_GeographicDivision';
  protected $divisionsDataType = 'map';
  public $kind;
  protected $normalizedInputType = 'Shortify_WP_Google_Service_CivicInfo_SimpleAddressType';
  protected $normalizedInputDataType = '';
  protected $officesType = 'Shortify_WP_Google_Service_CivicInfo_Office';
  protected $officesDataType = 'map';
  protected $officialsType = 'Shortify_WP_Google_Service_CivicInfo_Official';
  ...
  public function setNormalizedInput(Shortify_WP_Google_Service_CivicInfo_SimpleAddressType $normalizedInput)
  {
...
class Shortify_WP_Google_Service_CivicInfo_RepresentativeInfoResponseDivisions extends Shortify_WP_Google_Model
{

}

class Shortify_WP_Google_Service_CivicInfo_RepresentativeInfoResponseOffices extends Shortify_WP_Google_Model
{

}

class Shortify_WP_Google_Service_CivicInfo_RepresentativeInfoResponseOfficials extends Shortify_WP_Google_Model
{

}

class Shortify_WP_Google_Service_CivicInfo_SimpleAddressType extends Shortify_WP_Google_Model
{
  public $city;
  public $line1;
  public $line2;
...
class Shortify_WP_Google_Service_CivicInfo_Source extends Shortify_WP_Google_Model
{
  public $name;
  public $official;
...
class Shortify_WP_Google_Service_CivicInfo_VoterInfoRequest extends Shortify_WP_Google_Model
{
  public $address;
...
class Shortify_WP_Google_Service_CivicInfo_VoterInfoResponse extends Shortify_WP_Google_Collection
{
  protected $contestsType = 'Shortify_WP_Google_Service_CivicInfo_Contest';
  protected $contestsDataType = 'array';
  protected $earlyVoteSitesType = 'Shortify_WP_Google_Service_CivicInfo_PollingLocation';
  protected $earlyVoteSitesDataType = 'array';
  protected $electionType = 'Shortify_WP_Google_Service_CivicInfo_Election';
  protected $electionDataType = '';
  public $kind;
  protected $normalizedInputType = 'Shortify_WP_Google_Service_CivicInfo_SimpleAddressType';
  protected $normalizedInputDataType = '';
  protected $pollingLocationsType = 'Shortify_WP_Google_Service_CivicInfo_PollingLocation';
  protected $pollingLocationsDataType = 'array';
  protected $stateType = 'Shortify_WP_Google_Service_CivicInfo_AdministrationRegion';
  ...
  public function setElection(Shortify_WP_Google_Service_CivicInfo_Election $election)
  {
