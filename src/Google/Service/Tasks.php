 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_Tasks extends Shortify_WP_Google_Service
{
  /** Manage your tasks. */
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->tasklists = new Shortify_WP_Google_Service_Tasks_Tasklists_Resource(
        $this,
        $this->serviceName,
        'tasklists',
        array(
    ...
    $this->tasks = new Shortify_WP_Google_Service_Tasks_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $tasksService = new Shortify_WP_Google_Service_Tasks(...);
 *   $tasklists = $tasksService->tasklists;
 *  </code>
 */
class Shortify_WP_Google_Service_Tasks_Tasklists_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * Task list identifier.
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_Tasks_TaskList
   */
  public function get($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Shortify_WP_Google_Service_Tasks_TaskList");
  }
  /**
   * Creates a new task list and adds it to the authenticated user's task lists.
   * (tasklists.insert)
   *
   * @param Shortify_WP_Google_TaskList $postBody
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_Tasks_TaskList
   */
  public function insert(Shortify_WP_Google_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Shortify_WP_Google_Service_Tasks_TaskList");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Tasks_TaskLists
   */
  public function listTasklists($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Shortify_WP_Google_Service_Tasks_TaskLists");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Tasks_TaskList
   */
  public function patch($tasklist, Shortify_WP_Google_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Shortify_WP_Google_Service_Tasks_TaskList");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Tasks_TaskList
   */
  public function update($tasklist, Shortify_WP_Google_Service_Tasks_TaskList $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Shortify_WP_Google_Service_Tasks_TaskList");
  }
}
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_Tasks_Tasks_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * Task identifier.
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_Tasks_Task
   */
  public function get($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Shortify_WP_Google_Service_Tasks_Task");
  }
  /**
   ...
   * @param string $tasklist
   * Task list identifier.
   * @param Shortify_WP_Google_Task $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Shortify_WP_Google_Service_Tasks_Task
   */
  public function insert($tasklist, Shortify_WP_Google_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Shortify_WP_Google_Service_Tasks_Task");
  }
  /**
   ...
   * Lower bound for a task's due date (as a RFC 3339 timestamp) to filter by. Optional. The default
    * is not to filter by due date.
   * @return Shortify_WP_Google_Service_Tasks_Tasks
   */
  public function listTasks($tasklist, $optParams = array())
  {
    $params = array('tasklist' => $tasklist);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Shortify_WP_Google_Service_Tasks_Tasks");
  }
  /**
  ...
  public function move($tasklist, $task, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('move', array($params), "Shortify_WP_Google_Service_Tasks_Task");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Tasks_Task
   */
  public function patch($tasklist, $task, Shortify_WP_Google_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Shortify_WP_Google_Service_Tasks_Task");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Tasks_Task
   */
  public function update($tasklist, $task, Shortify_WP_Google_Service_Tasks_Task $postBody, $optParams = array())
  {
    $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Shortify_WP_Google_Service_Tasks_Task");
  }
}
...
class Shortify_WP_Google_Service_Tasks_Task extends Shortify_WP_Google_Collection
{
  public $completed;
  public $deleted;
  public $due;
  ...
  public $id;
  public $kind;
  protected $linksType = 'Shortify_WP_Google_Service_Tasks_TaskLinks';
...
class Shortify_WP_Google_Service_Tasks_TaskLinks extends Shortify_WP_Google_Model
{
  public $description;
  public $link;
  public $type;
...
class Shortify_WP_Google_Service_Tasks_TaskList extends Shortify_WP_Google_Model
{
  public $etag;
  public $id;
  public $kind;
...
class Shortify_WP_Google_Service_Tasks_TaskLists extends Shortify_WP_Google_Collection
{
  public $etag;
  protected $itemsType = 'Shortify_WP_Google_Service_Tasks_TaskList';
...
class Shortify_WP_Google_Service_Tasks_Tasks extends Shortify_WP_Google_Collection
{
  public $etag;
  protected $itemsType = 'Shortify_WP_Google_Service_Tasks_Task';
  protected $itemsDataType = 'array';
  public $kind;
  public $nextPageToken;
