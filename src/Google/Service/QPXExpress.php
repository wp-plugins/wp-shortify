 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_QPXExpress extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->trips = new Shortify_WP_Google_Service_QPXExpress_Trips_Resource(
        $this,
        $this->serviceName,
        'trips',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $qpxExpressService = new Shortify_WP_Google_Service_QPXExpress(...);
 *   $trips = $qpxExpressService->trips;
 *  </code>
 */
class Shortify_WP_Google_Service_QPXExpress_Trips_Resource extends Shortify_WP_Google_Service_Resource
{

  /**
   * Returns a list of flights. (trips.search)
   *
   * @param Shortify_WP_Google_TripsSearchRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_QPXExpress_TripsSearchResponse
   */
  public function search(Shortify_WP_Google_Service_QPXExpress_TripsSearchRequest $postBody, $optParams = array())
  {
    $params = array('postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search', array($params), "Shortify_WP_Google_Service_QPXExpress_TripsSearchResponse");
  }
}
...
class Shortify_WP_Google_Service_QPXExpress_AircraftData extends Shortify_WP_Google_Model
{
  public $code;
  public $kind;
  public $name;
...
class Shortify_WP_Google_Service_QPXExpress_AirportData extends Shortify_WP_Google_Model
{
  public $city;
  public $code;
  public $kind;
...
class Shortify_WP_Google_Service_QPXExpress_BagDescriptor extends Shortify_WP_Google_Collection
{
...
class Shortify_WP_Google_Service_QPXExpress_CarrierData extends Shortify_WP_Google_Model
{
  public $code;
  public $kind;
  public $name;
...
class Shortify_WP_Google_Service_QPXExpress_CityData extends Shortify_WP_Google_Model
{
  public $code;
  public $country;
  public $kind;
...
class Shortify_WP_Google_Service_QPXExpress_Data extends Shortify_WP_Google_Collection
{
  protected $aircraftType = 'Shortify_WP_Google_Service_QPXExpress_AircraftData';
  protected $aircraftDataType = 'array';
  protected $airportType = 'Shortify_WP_Google_Service_QPXExpress_AirportData';
  protected $airportDataType = 'array';
  protected $carrierType = 'Shortify_WP_Google_Service_QPXExpress_CarrierData';
  protected $carrierDataType = 'array';
  protected $cityType = 'Shortify_WP_Google_Service_QPXExpress_CityData';
  protected $cityDataType = 'array';
  public $kind;
  protected $taxType = 'Shortify_WP_Google_Service_QPXExpress_TaxData';
...
class Shortify_WP_Google_Service_QPXExpress_FareInfo extends Shortify_WP_Google_Model
{
  public $basisCode;
  public $carrier;
  public $destination;
...
class Shortify_WP_Google_Service_QPXExpress_FlightInfo extends Shortify_WP_Google_Model
{
  public $carrier;
  public $number;
...
class Shortify_WP_Google_Service_QPXExpress_FreeBaggageAllowance extends Shortify_WP_Google_Collection
{
  protected $bagDescriptorType = 'Shortify_WP_Google_Service_QPXExpress_BagDescriptor';
...
class Shortify_WP_Google_Service_QPXExpress_LegInfo extends Shortify_WP_Google_Model
{
  public $aircraft;
  public $arrivalTime;
  public $changePlane;
...
class Shortify_WP_Google_Service_QPXExpress_PassengerCounts extends Shortify_WP_Google_Model
{
  public $adultCount;
  public $childCount;
...
class Shortify_WP_Google_Service_QPXExpress_PricingInfo extends Shortify_WP_Google_Collection
{
  public $baseFareTotal;
  protected $fareType = 'Shortify_WP_Google_Service_QPXExpress_FareInfo';
  protected $fareDataType = 'array';
  public $fareCalculation;
  public $kind;
  public $latestTicketingTime;
  protected $passengersType = 'Shortify_WP_Google_Service_QPXExpress_PassengerCounts';
  ...
  public $saleTaxTotal;
  public $saleTotal;
  protected $segmentPricingType = 'Shortify_WP_Google_Service_QPXExpress_SegmentPricing';
  protected $segmentPricingDataType = 'array';
  protected $taxType = 'Shortify_WP_Google_Service_QPXExpress_TaxInfo';
  protected $taxDataType = 'array';
  ...
  public function setPassengers(Shortify_WP_Google_Service_QPXExpress_PassengerCounts $passengers)
  {
...
class Shortify_WP_Google_Service_QPXExpress_SegmentInfo extends Shortify_WP_Google_Collection
{
  public $bookingCode;
  ...
  public $connectionDuration;
  public $duration;
  protected $flightType = 'Shortify_WP_Google_Service_QPXExpress_FlightInfo';
  protected $flightDataType = '';
  public $id;
  public $kind;
  protected $legType = 'Shortify_WP_Google_Service_QPXExpress_LegInfo';
  ...
  public function setFlight(Shortify_WP_Google_Service_QPXExpress_FlightInfo $flight)
  {
    $this->flight = $flight;
  }
...
class Shortify_WP_Google_Service_QPXExpress_SegmentPricing extends Shortify_WP_Google_Collection
{
  public $fareId;
  protected $freeBaggageOptionType = 'Shortify_WP_Google_Service_QPXExpress_FreeBaggageAllowance';
...
class Shortify_WP_Google_Service_QPXExpress_SliceInfo extends Shortify_WP_Google_Collection
{
  public $duration;
  public $kind;
  protected $segmentType = 'Shortify_WP_Google_Service_QPXExpress_SegmentInfo';
...
class Shortify_WP_Google_Service_QPXExpress_SliceInput extends Shortify_WP_Google_Collection
{
  public $alliance;
  public $date;
  public $destination;
  ...
  protected $permittedDepartureTimeType = 'Shortify_WP_Google_Service_QPXExpress_TimeOfDayRange';
  ...
  public function setPermittedDepartureTime(Shortify_WP_Google_Service_QPXExpress_TimeOfDayRange $permittedDepartureTime)
  {
...
class Shortify_WP_Google_Service_QPXExpress_TaxData extends Shortify_WP_Google_Model
{
  public $id;
  public $kind;
  public $name;
...
class Shortify_WP_Google_Service_QPXExpress_TaxInfo extends Shortify_WP_Google_Model
{
  public $chargeType;
  public $code;
  public $country;
...
class Shortify_WP_Google_Service_QPXExpress_TimeOfDayRange extends Shortify_WP_Google_Model
{
  public $earliestTime;
  public $kind;
  public $latestTime;
...
class Shortify_WP_Google_Service_QPXExpress_TripOption extends Shortify_WP_Google_Collection
{
  public $id;
  public $kind;
  protected $pricingType = 'Shortify_WP_Google_Service_QPXExpress_PricingInfo';
  protected $pricingDataType = 'array';
  public $saleTotal;
  protected $sliceType = 'Shortify_WP_Google_Service_QPXExpress_SliceInfo';
...
class Shortify_WP_Google_Service_QPXExpress_TripOptionsRequest extends Shortify_WP_Google_Collection
{
  public $maxPrice;
  protected $passengersType = 'Shortify_WP_Google_Service_QPXExpress_PassengerCounts';
  protected $passengersDataType = '';
  public $refundable;
  public $saleCountry;
  protected $sliceType = 'Shortify_WP_Google_Service_QPXExpress_SliceInput';
  protected $sliceDataType = 'array';
  public $solutions;
...
class Shortify_WP_Google_Service_QPXExpress_TripOptionsResponse extends Shortify_WP_Google_Collection
{
  protected $dataType = 'Shortify_WP_Google_Service_QPXExpress_Data';
  protected $dataDataType = '';
  public $kind;
  public $requestId;
  protected $tripOptionType = 'Shortify_WP_Google_Service_QPXExpress_TripOption';
  protected $tripOptionDataType = 'array';

  public function setData(Shortify_WP_Google_Service_QPXExpress_Data $data)
  {
    $this->data = $data;
  }
...
class Shortify_WP_Google_Service_QPXExpress_TripsSearchRequest extends Shortify_WP_Google_Model
{
  protected $requestType = 'Shortify_WP_Google_Service_QPXExpress_TripOptionsRequest';
  protected $requestDataType = '';

  public function setRequest(Shortify_WP_Google_Service_QPXExpress_TripOptionsRequest $request)
  {
...
class Shortify_WP_Google_Service_QPXExpress_TripsSearchResponse extends Shortify_WP_Google_Model
{
  public $kind;
  protected $tripsType = 'Shortify_WP_Google_Service_QPXExpress_TripOptionsResponse';
  ...
  public function setTrips(Shortify_WP_Google_Service_QPXExpress_TripOptionsResponse $trips)
  {
    $this->trips = $trips;
  }
