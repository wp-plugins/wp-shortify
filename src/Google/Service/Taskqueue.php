 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_Taskqueue extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->taskqueues = new Shortify_WP_Google_Service_Taskqueue_Taskqueues_Resource(
        $this,
        $this->serviceName,
        'taskqueues',
        array(
    ...
    $this->tasks = new Shortify_WP_Google_Service_Taskqueue_Tasks_Resource(
        $this,
        $this->serviceName,
        'tasks',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $taskqueueService = new Shortify_WP_Google_Service_Taskqueue(...);
 *   $taskqueues = $taskqueueService->taskqueues;
 *  </code>
 */
class Shortify_WP_Google_Service_Taskqueue_Taskqueues_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @return Shortify_WP_Google_Service_Taskqueue_TaskQueue
   */
  public function get($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Shortify_WP_Google_Service_Taskqueue_TaskQueue");
  }
}
 ...
 *  </code>
 */
class Shortify_WP_Google_Service_Taskqueue_Tasks_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_Taskqueue_Task
   */
  public function get($project, $taskqueue, $task, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Shortify_WP_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Taskqueue_Task
   */
  public function insert($project, $taskqueue, Shortify_WP_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('insert', array($params), "Shortify_WP_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Taskqueue_Tasks
   */
  public function lease($project, $taskqueue, $numTasks, $leaseSecs, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('lease', array($params), "Shortify_WP_Google_Service_Taskqueue_Tasks");
  }
  /**
   ...
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_Taskqueue_Tasks2
   */
  public function listTasks($project, $taskqueue, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Shortify_WP_Google_Service_Taskqueue_Tasks2");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Taskqueue_Task
   */
  public function patch($project, $taskqueue, $task, $newLeaseSeconds, Shortify_WP_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Shortify_WP_Google_Service_Taskqueue_Task");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Taskqueue_Task
   */
  public function update($project, $taskqueue, $task, $newLeaseSeconds, Shortify_WP_Google_Service_Taskqueue_Task $postBody, $optParams = array())
  {
    $params = array('project' => $project, 'taskqueue' => $taskqueue, 'task' => $task, 'newLeaseSeconds' => $newLeaseSeconds, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Shortify_WP_Google_Service_Taskqueue_Task");
  }
}
...
class Shortify_WP_Google_Service_Taskqueue_Task extends Shortify_WP_Google_Model
{
...
class Shortify_WP_Google_Service_Taskqueue_TaskQueue extends Shortify_WP_Google_Model
{
  protected $aclType = 'Shortify_WP_Google_Service_Taskqueue_TaskQueueAcl';
  protected $aclDataType = '';
  public $id;
  public $kind;
  public $maxLeases;
  protected $statsType = 'Shortify_WP_Google_Service_Taskqueue_TaskQueueStats';
  protected $statsDataType = '';

  public function setAcl(Shortify_WP_Google_Service_Taskqueue_TaskQueueAcl $acl)
  {
    $this->acl = $acl;
  }
  ...
  public function setStats(Shortify_WP_Google_Service_Taskqueue_TaskQueueStats $stats)
  {
    $this->stats = $stats;
  }
...
class Shortify_WP_Google_Service_Taskqueue_TaskQueueAcl extends Shortify_WP_Google_Collection
{
  public $adminEmails;
...
class Shortify_WP_Google_Service_Taskqueue_TaskQueueStats extends Shortify_WP_Google_Model
{
...
class Shortify_WP_Google_Service_Taskqueue_Tasks extends Shortify_WP_Google_Collection
{
  protected $itemsType = 'Shortify_WP_Google_Service_Taskqueue_Task';
...
class Shortify_WP_Google_Service_Taskqueue_Tasks2 extends Shortify_WP_Google_Collection
{
  protected $itemsType = 'Shortify_WP_Google_Service_Taskqueue_Task';
  protected $itemsDataType = 'array';
  public $kind;
