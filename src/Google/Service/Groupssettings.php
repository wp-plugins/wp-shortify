 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_Groupssettings extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->groups = new Shortify_WP_Google_Service_Groupssettings_Groups_Resource(
        $this,
        $this->serviceName,
        'groups',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $groupssettingsService = new Shortify_WP_Google_Service_Groupssettings(...);
 *   $groups = $groupssettingsService->groups;
 *  </code>
 */
class Shortify_WP_Google_Service_Groupssettings_Groups_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @return Shortify_WP_Google_Service_Groupssettings_Groups
   */
  public function get($groupUniqueId, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Shortify_WP_Google_Service_Groupssettings_Groups");
  }
  /**
   ...
   * @param string $groupUniqueId
   * The resource ID
   * @param Shortify_WP_Google_Groups $postBody
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_Groupssettings_Groups
   */
  public function patch($groupUniqueId, Shortify_WP_Google_Service_Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Shortify_WP_Google_Service_Groupssettings_Groups");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_Groupssettings_Groups
   */
  public function update($groupUniqueId, Shortify_WP_Google_Service_Groupssettings_Groups $postBody, $optParams = array())
  {
    $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Shortify_WP_Google_Service_Groupssettings_Groups");
  }
}
...
class Shortify_WP_Google_Service_Groupssettings_Groups extends Shortify_WP_Google_Model
{
