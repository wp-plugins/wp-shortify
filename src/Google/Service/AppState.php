 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_AppState extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->states = new Shortify_WP_Google_Service_AppState_States_Resource(
        $this,
        $this->serviceName,
        'states',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appstateService = new Shortify_WP_Google_Service_AppState(...);
 *   $states = $appstateService->states;
 *  </code>
 */
class Shortify_WP_Google_Service_AppState_States_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @return Shortify_WP_Google_Service_AppState_WriteResult
   */
  public function clear($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('clear', array($params), "Shortify_WP_Google_Service_AppState_WriteResult");
  }
  /**
   ...
   * The key for the data to be retrieved.
   * @param array $optParams Optional parameters.
   * @return Shortify_WP_Google_Service_AppState_GetResponse
   */
  public function get($stateKey, $optParams = array())
  {
    $params = array('stateKey' => $stateKey);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Shortify_WP_Google_Service_AppState_GetResponse");
  }
  /**
   ...
   * @return Shortify_WP_Google_Service_AppState_ListResponse
   */
  public function listStates($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Shortify_WP_Google_Service_AppState_ListResponse");
  }
  /**
   ...
   * @param int $stateKey
   * The key for the data to be retrieved.
   * @param Shortify_WP_Google_UpdateRequest $postBody
   * @param array $optParams Optional parameters.
   *
   ...
   * @return Shortify_WP_Google_Service_AppState_WriteResult
   */
  public function update($stateKey, Shortify_WP_Google_Service_AppState_UpdateRequest $postBody, $optParams = array())
  {
    $params = array('stateKey' => $stateKey, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('update', array($params), "Shortify_WP_Google_Service_AppState_WriteResult");
  }
}
...
class Shortify_WP_Google_Service_AppState_GetResponse extends Shortify_WP_Google_Model
{
...
class Shortify_WP_Google_Service_AppState_ListResponse extends Shortify_WP_Google_Collection
{
  protected $itemsType = 'Shortify_WP_Google_Service_AppState_GetResponse';
...
class Shortify_WP_Google_Service_AppState_UpdateRequest extends Shortify_WP_Google_Model
{
  public $data;
  public $kind;
...
class Shortify_WP_Google_Service_AppState_WriteResult extends Shortify_WP_Google_Model
{
  public $currentStateVersion;
  public $kind;
  public $stateKey;
