 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_Admin extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->mail = new Shortify_WP_Google_Service_Admin_Mail_Resource(
        $this,
        $this->serviceName,
        'mail',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $adminService = new Shortify_WP_Google_Service_Admin(...);
 *   $mail = $adminService->mail;
 *  </code>
 */
class Shortify_WP_Google_Service_Admin_Mail_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * @param Shortify_WP_Google_MailItem $postBody
   * @param array $optParams Optional parameters.
   */
  public function insert($userKey, Shortify_WP_Google_Service_Admin_MailItem $postBody, $optParams = array())
  {
...
class Shortify_WP_Google_Service_Admin_MailItem extends Shortify_WP_Google_Collection
{
  public $isDeleted;
  public $isDraft;
  public $isInbox;
