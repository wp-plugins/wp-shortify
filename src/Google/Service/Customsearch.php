 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_Customsearch extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->cse = new Shortify_WP_Google_Service_Customsearch_Cse_Resource(
        $this,
        $this->serviceName,
        'cse',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $customsearchService = new Shortify_WP_Google_Service_Customsearch(...);
 *   $cse = $customsearchService->cse;
 *  </code>
 */
class Shortify_WP_Google_Service_Customsearch_Cse_Resource extends Shortify_WP_Google_Service_Resource
{
   ...
   * Controls whether to include or exclude results from the site named in the as_sitesearch
    * parameter
   * @return Shortify_WP_Google_Service_Customsearch_Search
   */
  public function listCse($q, $optParams = array())
  {
    $params = array('q' => $q);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Shortify_WP_Google_Service_Customsearch_Search");
  }
}
...
class Shortify_WP_Google_Service_Customsearch_Context extends Shortify_WP_Google_Collection
{
  protected $facetsType = 'Shortify_WP_Google_Service_Customsearch_ContextFacets';
...
class Shortify_WP_Google_Service_Customsearch_ContextFacets extends Shortify_WP_Google_Model
{
  public $anchor;
  public $label;
  public $labelWithOp;
...
class Shortify_WP_Google_Service_Customsearch_Promotion extends Shortify_WP_Google_Collection
{
  protected $bodyLinesType = 'Shortify_WP_Google_Service_Customsearch_PromotionBodyLines';
  protected $bodyLinesDataType = 'array';
  public $displayLink;
  public $htmlTitle;
  protected $imageType = 'Shortify_WP_Google_Service_Customsearch_PromotionImage';
  ...
  public function setImage(Shortify_WP_Google_Service_Customsearch_PromotionImage $image)
  {
    $this->image = $image;
  }
...
class Shortify_WP_Google_Service_Customsearch_PromotionBodyLines extends Shortify_WP_Google_Model
{
  public $htmlTitle;
  public $link;
  public $title;
...
class Shortify_WP_Google_Service_Customsearch_PromotionImage extends Shortify_WP_Google_Model
{
  public $height;
  public $source;
  public $width;
...
class Shortify_WP_Google_Service_Customsearch_Query extends Shortify_WP_Google_Model
{
  public $count;
  public $cr;
  public $cref;
...
class Shortify_WP_Google_Service_Customsearch_Result extends Shortify_WP_Google_Collection
{
  public $cacheId;
  public $displayLink;
  public $fileFormat;
  ...
  public $htmlSnippet;
  public $htmlTitle;
  protected $imageType = 'Shortify_WP_Google_Service_Customsearch_ResultImage';
  protected $imageDataType = '';
  public $kind;
  protected $labelsType = 'Shortify_WP_Google_Service_Customsearch_ResultLabels';
  ...
  public function setImage(Shortify_WP_Google_Service_Customsearch_ResultImage $image)
  {
    $this->image = $image;
  }
...
class Shortify_WP_Google_Service_Customsearch_ResultImage extends Shortify_WP_Google_Model
{
  public $byteSize;
  public $contextLink;
  public $height;
...
class Shortify_WP_Google_Service_Customsearch_ResultLabels extends Shortify_WP_Google_Model
{
  public $displayName;
  public $labelWithOp;
  public $name;
...
class Shortify_WP_Google_Service_Customsearch_ResultPagemap extends Shortify_WP_Google_Model
{

}

class Shortify_WP_Google_Service_Customsearch_ResultPagemapItemElement extends Shortify_WP_Google_Model
{

}

class Shortify_WP_Google_Service_Customsearch_Search extends Shortify_WP_Google_Collection
{
  protected $contextType = 'Shortify_WP_Google_Service_Customsearch_Context';
  protected $contextDataType = '';
  protected $itemsType = 'Shortify_WP_Google_Service_Customsearch_Result';
  protected $itemsDataType = 'array';
  public $kind;
  protected $promotionsType = 'Shortify_WP_Google_Service_Customsearch_Promotion';
  protected $promotionsDataType = 'array';
  protected $queriesType = 'Shortify_WP_Google_Service_Customsearch_Query';
  protected $queriesDataType = 'map';
  protected $searchInformationType = 'Shortify_WP_Google_Service_Customsearch_SearchSearchInformation';
  protected $searchInformationDataType = '';
  protected $spellingType = 'Shortify_WP_Google_Service_Customsearch_SearchSpelling';
  protected $spellingDataType = '';
  protected $urlType = 'Shortify_WP_Google_Service_Customsearch_SearchUrl';
  protected $urlDataType = '';

  public function setContext(Shortify_WP_Google_Service_Customsearch_Context $context)
  {
  ...
  public function setSearchInformation(Shortify_WP_Google_Service_Customsearch_SearchSearchInformation $searchInformation)
  {
  ...
  public function setSpelling(Shortify_WP_Google_Service_Customsearch_SearchSpelling $spelling)
  {
  ...
  public function setUrl(Shortify_WP_Google_Service_Customsearch_SearchUrl $url)
  {
    $this->url = $url;
  }
...
class Shortify_WP_Google_Service_Customsearch_SearchQueries extends Shortify_WP_Google_Model
{

}

class Shortify_WP_Google_Service_Customsearch_SearchSearchInformation extends Shortify_WP_Google_Model
{
...
class Shortify_WP_Google_Service_Customsearch_SearchSpelling extends Shortify_WP_Google_Model
{
...
class Shortify_WP_Google_Service_Customsearch_SearchUrl extends Shortify_WP_Google_Model
{
  public $template;
  public $type;
