 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_Appsactivity extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->activities = new Shortify_WP_Google_Service_Appsactivity_Activities_Resource(
        $this,
        $this->serviceName,
        'activities',
        array(
 ...
 * Typical usage is:
 *  <code>
 *   $appsactivityService = new Shortify_WP_Google_Service_Appsactivity(...);
 *   $activities = $appsactivityService->activities;
 *  </code>
 */
class Shortify_WP_Google_Service_Appsactivity_Activities_Resource extends Shortify_WP_Google_Service_Resource
{
  ...
  -
    * drive.google.com
   * @return Shortify_WP_Google_Service_Appsactivity_ListActivitiesResponse
   */
  public function listActivities($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Shortify_WP_Google_Service_Appsactivity_ListActivitiesResponse");
  }
}
...
class Shortify_WP_Google_Service_Appsactivity_Activity extends Shortify_WP_Google_Collection
{
  protected $combinedEventType = 'Shortify_WP_Google_Service_Appsactivity_Event';
  protected $combinedEventDataType = '';
  protected $singleEventsType = 'Shortify_WP_Google_Service_Appsactivity_Event';
  protected $singleEventsDataType = 'array';

  public function setCombinedEvent(Shortify_WP_Google_Service_Appsactivity_Event $combinedEvent)
  {
...
class Shortify_WP_Google_Service_Appsactivity_Event extends Shortify_WP_Google_Collection
{
  public $additionalEventTypes;
  public $eventTimeMillis;
  public $fromUserDeletion;
  protected $moveType = 'Shortify_WP_Google_Service_Appsactivity_Move';
  protected $moveDataType = '';
  protected $permissionChangesType = 'Shortify_WP_Google_Service_Appsactivity_PermissionChange';
  protected $permissionChangesDataType = 'array';
  public $primaryEventType;
  protected $renameType = 'Shortify_WP_Google_Service_Appsactivity_Rename';
  protected $renameDataType = '';
  protected $targetType = 'Shortify_WP_Google_Service_Appsactivity_Target';
  protected $targetDataType = '';
  protected $userType = 'Shortify_WP_Google_Service_Appsactivity_User';
  ...
  public function setMove(Shortify_WP_Google_Service_Appsactivity_Move $move)
  {
    $this->move = $move;
  }
  ...
  public function setRename(Shortify_WP_Google_Service_Appsactivity_Rename $rename)
  {
    $this->rename = $rename;
  }
  ...
  public function setTarget(Shortify_WP_Google_Service_Appsactivity_Target $target)
  {
    $this->target = $target;
  }
  ...
  public function setUser(Shortify_WP_Google_Service_Appsactivity_User $user)
  {
    $this->user = $user;
  }
...
class Shortify_WP_Google_Service_Appsactivity_ListActivitiesResponse extends Shortify_WP_Google_Collection
{
  protected $activitiesType = 'Shortify_WP_Google_Service_Appsactivity_Activity';
...
class Shortify_WP_Google_Service_Appsactivity_Move extends Shortify_WP_Google_Collection
{
  protected $addedParentsType = 'Shortify_WP_Google_Service_Appsactivity_Parent';
  protected $addedParentsDataType = 'array';
  protected $removedParentsType = 'Shortify_WP_Google_Service_Appsactivity_Parent';
...
class Shortify_WP_Google_Service_Appsactivity_Parent extends Shortify_WP_Google_Model
{
  public $id;
  public $isRoot;
  public $title;
...
class Shortify_WP_Google_Service_Appsactivity_Permission extends Shortify_WP_Google_Model
{
  public $name;
  public $permissionId;
  public $role;
...
class Shortify_WP_Google_Service_Appsactivity_PermissionChange extends Shortify_WP_Google_Collection
{
  protected $addedPermissionsType = 'Shortify_WP_Google_Service_Appsactivity_Permission';
  protected $addedPermissionsDataType = 'array';
  protected $removedPermissionsType = 'Shortify_WP_Google_Service_Appsactivity_Permission';
...
class Shortify_WP_Google_Service_Appsactivity_Photo extends Shortify_WP_Google_Model
{
  public $url;
...
class Shortify_WP_Google_Service_Appsactivity_Rename extends Shortify_WP_Google_Model
{
  public $newTitle;
  public $oldTitle;
...
class Shortify_WP_Google_Service_Appsactivity_Target extends Shortify_WP_Google_Model
{
  public $id;
  public $mimeType;
  public $name;
...
class Shortify_WP_Google_Service_Appsactivity_User extends Shortify_WP_Google_Model
{
  public $name;
  protected $photoType = 'Shortify_WP_Google_Service_Appsactivity_Photo';
  ...
  public function setPhoto(Shortify_WP_Google_Service_Appsactivity_Photo $photo)
  {
    $this->photo = $photo;
  }
