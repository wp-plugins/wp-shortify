 ...
 * @author Google, Inc.
 */
class Shortify_WP_Google_Service_Freebase extends Shortify_WP_Google_Service
{
  ...
  public function __construct(Shortify_WP_Google_Client $client)
  {
    ...
    $this->base_methods = new Shortify_WP_Google_Service_Resource(
        $this,
        $this->serviceName,
        '',
        array(
   ...
   * @return Shortify_WP_Google_Service_Freebase_ReconcileGet
   */
  public function reconcile($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->base_methods->call('reconcile', array($params), "Shortify_WP_Google_Service_Freebase_ReconcileGet");
  }
  /**
...
class Shortify_WP_Google_Service_Freebase_ReconcileCandidate extends Shortify_WP_Google_Model
{
  public $confidence;
  public $lang;
  public $mid;
  public $name;
  protected $notableType = 'Shortify_WP_Google_Service_Freebase_ReconcileCandidateNotable';
  ...
  public function setNotable(Shortify_WP_Google_Service_Freebase_ReconcileCandidateNotable $notable)
  {
...
class Shortify_WP_Google_Service_Freebase_ReconcileCandidateNotable extends Shortify_WP_Google_Model
{
  public $id;
  public $name;
...
class Shortify_WP_Google_Service_Freebase_ReconcileGet extends Shortify_WP_Google_Collection
{
  protected $candidateType = 'Shortify_WP_Google_Service_Freebase_ReconcileCandidate';
  protected $candidateDataType = 'array';
  protected $costsType = 'Shortify_WP_Google_Service_Freebase_ReconcileGetCosts';
  protected $costsDataType = '';
  protected $matchType = 'Shortify_WP_Google_Service_Freebase_ReconcileCandidate';
  protected $matchDataType = '';
  protected $warningType = 'Shortify_WP_Google_Service_Freebase_ReconcileGetWarning';
  ...
  public function setCosts(Shortify_WP_Google_Service_Freebase_ReconcileGetCosts $costs)
  {
    $this->costs = $costs;
  }
  ...
  public function setMatch(Shortify_WP_Google_Service_Freebase_ReconcileCandidate $match)
  {
    $this->match = $match;
  }
...
class Shortify_WP_Google_Service_Freebase_ReconcileGetCosts extends Shortify_WP_Google_Model
{
  public $hits;
  public $ms;
...
class Shortify_WP_Google_Service_Freebase_ReconcileGetWarning extends Shortify_WP_Google_Model
{
  public $location;
  public $message;
  public $reason;
